...
// Rota padrão do app: São Paulo (GRU/CGH/VCP, escolhidos pelo usuário) <-> Cascavel/PR (CAC).
export const DEFAULT_ORIGIN = "GRU";
export const DEFAULT_DESTINATION = "CAC";

export const AIRPORTS: Airport[] = [
  // Grupo "São Paulo" - o usuário escolhe qual dos três usar
  ...
  // Outros aeroportos nacionais relevantes
  ...
  // Internacionais mais buscados a partir do Brasil
